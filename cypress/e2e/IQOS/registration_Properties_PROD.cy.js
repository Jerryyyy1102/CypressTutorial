describe('AEM Registration Page', () => {
    ...
    beforeEach(() => {
        cy.visit('https://author.iqos.com/editor.html/content/pmisite/id/en/registration.html');
    ...
    it('Properties', () => {
        ...
        for (let i = 3; i <= 23; i++) {
            ...
            const parentSelector = `#coral-${94 + (i - 3)}`; // Tính toán id cha tương ứng
    ...
    after(() => {
        ...
        cy.writeFile('cypress/fixtures/registration_properties_prod.json', JSON.stringify(allResultsContent, null, 2))
        .then(() => {
            ...
            cy.writeFile(`cypress/report/registration_PROD_${year}${month}${day}_${hours}${minutes}.txt`, contentString);
        })
        .then(() => {
