describe('AEM Registration Page', () => {
    ...
    beforeEach(() => {
        cy.visit('https://author.pp.iqos.com/editor.html/content/pmisite/id/en/registration.html');
    ...
    after(() => {
        ...
        cy.writeFile('cypress/fixtures/registration_properties_pp.json', JSON.stringify(allResultsContent, null, 2))
        .then(() => {
            ...
            cy.writeFile(`cypress/report/registration_PP_${year}${month}${day}_${hours}${minutes}.txt`, contentString);
        })
        .then(() => {
